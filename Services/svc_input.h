 ...
 * (Drivers_App/drv_encoder.c) into g_system_state for a future UI layer.
 * Also provides short buzzer feedback on every button press and encoder
 * turn. Call svc_input_update() from the scheduler every tick. */
