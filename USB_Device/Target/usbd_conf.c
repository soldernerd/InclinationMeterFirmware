...
void HAL_PCD_MspInit(PCD_HandleTypeDef* pcdHandle)
{
  ...
  */
  ...
  /* USER CODE BEGIN USB_DRD_FS_MspInit 1 */
    /* NOTE: an earlier iteration set SYSCFG_CFGR1 PA11_RMP/PA12_RMP here to
     * route USB DM/DP onto the PA9/PA10 pads. On this LQFP64 part PA11/PA12
     * are their own pins and the board wires USB there directly (USB DFU
     * from the ROM bootloader works without any remap), so that change only
